    ...
    return (() => {
      var t = {507: (t, e, r) => {
          ...
          function o() {
            ...
            if (240 == (240 & r)) {
              ...
              switch (t.channel = 15 & r, c) {
                ...
                case 9:
                  var u = n.readUInt8();
                  return t.type = 0 === u ? "noteOff" : "noteOn", t.noteNumber = s, t.velocity = u, 0 === u && (t.byte9 = true), t;
                case 10:
        ...
        function e(t, e, i) {
          ...
          for (a = 0; a < s; a++) false !== i.running && (i.running || e[a].running) || (c = null), c = r(o, e[a], c, i.useByte9ForNoteOff);
        ...
        function r(t, e, r, n) {
          ...
          switch (t.writeVarInt(a), i) {
            ...
            case "endSysEx":
              ...
              break;
            case "noteOff":
              (c = (false !== n && e.byte9 || n && 0 == e.velocity ? 144 : 128) | e.channel) !== r && t.writeUInt8(c), t.writeUInt8(e.noteNumber), t.writeUInt8(e.velocity);
              break;
            case "noteOn":
        ...
        Object.defineProperty(e, "__esModule", {value: true}), e.insert = e.search = undefined, e.search = r, e.insert = function (t, e, n) {
          if (undefined === n && (n = "ticks"), t.length) {
            var i = r(t, e[n], n);
            t.splice(i + 1, 0, e);
          } else t.push(e);
        };
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: true}), e.ControlChange = e.controlChangeIds = e.controlChangeNames = undefined, e.controlChangeNames = {1: "modulationWheel", 2: "breath", 4: "footController", 5: "portamentoTime", 7: "volume", 8: "balance", 10: "pan", 64: "sustain", 65: "portamentoTime", 66: "sostenuto", 67: "softPedal", 68: "legatoFootswitch", 84: "portamentoControl"}, e.controlChangeIds = Object.keys(e.controlChangeNames).reduce(function (t, r) {
        ...
        var r = new WeakMap, n = new WeakMap, i = function () {
          ...
          return Object.defineProperty(t.prototype, "number", {get: function () {
            return n.get(this);
          ...
          }, enumerable: false, configurable: true}), Object.defineProperty(t.prototype, "time", {get: function () {
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: true}), e.createControlChanges = undefined;
        var n = r(543);
        e.createControlChanges = function () {
          return new Proxy({}, {get: function (t, e) {
            return t[e] ? t[e] : n.controlChangeIds.hasOwnProperty(e) ? t[n.controlChangeIds[e]] : undefined;
          }, set: function (t, e, r) {
            return n.controlChangeIds.hasOwnProperty(e) ? t[n.controlChangeIds[e]] = r : t[e] = r, true;
          }});
        };
      }, 54: function (t, e, r) {
        "use strict";
        ...
        Object.defineProperty(e, "__esModule", {value: true}), e.encode = undefined;
        ...
        e.encode = function (t) {
          var e = {header: {format: 1, numTracks: t.tracks.length + 1, ticksPerBeat: t.header.ppq}, tracks: n([n(n(n(n([{absoluteTime: 0, deltaTime: 0, meta: true, text: t.header.name, type: "trackName"}], t.header.keySignatures.map(function (t) {
            return function (t) {
              var e = a.keySignatureKeys.indexOf(t.key);
              return {absoluteTime: t.ticks, deltaTime: 0, key: e + 7, meta: true, scale: "major" === t.scale ? 0 : 1, type: "keySignature"};
            }(t);
          }), true), t.header.meta.map(function (t) {
            return {absoluteTime: (e = t).ticks, deltaTime: 0, meta: true, text: e.text, type: e.type};
            var e;
          }), true), t.header.tempos.map(function (t) {
            return function (t) {
              return {absoluteTime: t.ticks, deltaTime: 0, meta: true, microsecondsPerBeat: Math.floor(6e7 / t.bpm), type: "setTempo"};
            }(t);
          }), true), t.header.timeSignatures.map(function (t) {
            return function (t) {
              return {absoluteTime: t.ticks, deltaTime: 0, denominator: t.timeSignature[1], meta: true, metronome: 24, numerator: t.timeSignature[0], thirtyseconds: 8, type: "timeSignature"};
            }(t);
          }), true)], t.tracks.map(function (t) {
            return n(n(n([(e = t.name, {absoluteTime: 0, deltaTime: 0, meta: true, text: e, type: "trackName"}), c(t)], function (t) {
              return (0, o.flatten)(t.notes.map(function (e) {
                return function (t, e) {
                  return [{absoluteTime: t.ticks, channel: e, deltaTime: 0, noteNumber: t.midi, type: "noteOn", velocity: Math.floor(127 * t.velocity)}, {absoluteTime: t.ticks + t.durationTicks, channel: e, deltaTime: 0, noteNumber: t.midi, type: "noteOff", velocity: Math.floor(127 * t.noteOffVelocity)}];
                }(e, t.channel);
              }));
            }(t), true), function (t) {
          ...
          return e.tracks = e.tracks.map(function (t) {
            ...
            }), t.push({deltaTime: 0, meta: true, type: "endOfTrack"}), t;
          }), new Uint8Array((0, i.writeMidi)(e));
        };
      }, 535: (t, e, r) => {
        "use strict";
        Object.defineProperty(e, "__esModule", {value: true}), e.Header = e.keySignatureKeys = undefined;
        ...
        var a = function () {
            ...
            if (this.tempos = [], this.timeSignatures = [], this.keySignatures = [], this.meta = [], this.name = "", i.set(this, 480), t) {
              i.set(this, t.header.ticksPerBeat), t.tracks.forEach(function (t) {
                t.forEach(function (t) {
                  t.meta && ("timeSignature" === t.type ? r.timeSignatures.push({ticks: t.absoluteTime, timeSignature: [t.numerator, t.denominator]}) : "setTempo" === t.type ? r.tempos.push({bpm: 6e7 / t.microsecondsPerBeat, ticks: t.absoluteTime}) : "keySignature" === t.type && r.keySignatures.push({key: e.keySignatureKeys[t.key + 7], scale: 0 === t.scale ? "major" : "minor", ticks: t.absoluteTime}));
                });
              });
              var n = 0;
              t.tracks[0].forEach(function (t) {
                n += t.deltaTime, t.meta && ("trackName" === t.type ? r.name = t.text : "text" !== t.type && "cuePoint" !== t.type && "marker" !== t.type && "lyrics" !== t.type || r.meta.push({text: t.text, ticks: n, type: t.type}));
              }), this.update();
            }
          }
          return t.prototype.update = function () {
            ...
            return t / this.ppq / 4;
          }, Object.defineProperty(t.prototype, "ppq", {get: function () {
            return i.get(this);
          }, enumerable: false, configurable: true}), t.prototype.secondsToTicks = function (t) {
            ...
            return {keySignatures: this.keySignatures, meta: this.meta, name: this.name, ppq: this.ppq, tempos: this.tempos.map(function (t) {
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: true}), e.Instrument = undefined;
        var n = r(438), i = new WeakMap, a = function () {
          ...
          return Object.defineProperty(t.prototype, "name", {get: function () {
            ...
            -1 !== e && (this.number = e);
          }, enumerable: false, configurable: true}), Object.defineProperty(t.prototype, "family", {get: function () {
            return this.percussion ? "drums" : n.InstrumentFamilyByID[Math.floor(this.number / 8)];
          }, enumerable: false, configurable: true}), Object.defineProperty(t.prototype, "percussion", {get: function () {
        ...
        Object.defineProperty(e, "__esModule", {value: true}), e.Header = e.Track = e.Midi = undefined;
        var a = r(289), o = r(535), s = r(334), c = r(54), u = function () {
          ...
          }, enumerable: false, configurable: true}), Object.defineProperty(t.prototype, "durationTicks", {get: function () {
            var t = this.tracks.map(function (t) {
              return t.durationTicks;
            });
            return Math.max.apply(Math, t);
          }, enumerable: false, configurable: true}), t.prototype.addTrack = function () {
            var t = new s.Track(undefined, this.header);
            return this.tracks.push(t), t;
          }, t.prototype.toArray = function () {
            return (0, c.encode)(this);
          }, t.prototype.toJSON = function () {
            return {header: this.header.toJSON(), tracks: this.tracks.map(function (t) {
              return t.toJSON();
            })};
          }, t.prototype.fromJSON = function (t) {
            var e = this;
            this.header = new o.Header, this.header.fromJSON(t.header), this.tracks = t.tracks.map(function (t) {
              var r = new s.Track(undefined, e.header);
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: true}), e.Note = undefined;
        var n, i, a = (n = /^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i, i = {cbb: -2, cb: -1, c: 0, "c#": 1, cx: 2, dbb: 0, db: 1, d: 2, "d#": 3, dx: 4, ebb: 2, eb: 3, e: 4, "e#": 5, ex: 6, fbb: 3, fb: 4, f: 5, "f#": 6, fx: 7, gbb: 5, gb: 6, g: 7, "g#": 8, gx: 9, abb: 7, ab: 8, a: 9, "a#": 10, ax: 11, bbb: 9, bb: 10, b: 11, "b#": 12, bx: 13}, function (t) {
          ...
          return Object.defineProperty(t.prototype, "name", {get: function () {
            return t = this.midi, e = Math.floor(t / 12) - 1, ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"][t % 12] + e.toString();
            var t, e;
          }, set: function (t) {
            this.midi = a(t);
          }, enumerable: false, configurable: true}), Object.defineProperty(t.prototype, "octave", {get: function () {
            return Math.floor(this.midi / 12) - 1;
          }, set: function (t) {
            var e = t - this.octave;
            this.midi += 12 * e;
          }, enumerable: false, configurable: true}), Object.defineProperty(t.prototype, "pitch", {get: function () {
            return ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"][this.midi % 12];
          }, set: function (t) {
            ...
            var e = o.get(this);
            this.ticks = e.secondsToTicks(t);
          }, enumerable: false, configurable: true}), Object.defineProperty(t.prototype, "bars", {get: function () {
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: true}), e.PitchBend = undefined;
        var r = new WeakMap, n = function () {
          function t(t, e) {
            r.set(this, e), this.ticks = t.absoluteTime, this.value = t.value;
          }
          return Object.defineProperty(t.prototype, "time", {get: function () {
            return r.get(this).ticksToSeconds(this.ticks);
          }, set: function (t) {
            var e = r.get(this);
            this.ticks = e.secondsToTicks(t);
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: true}), e.Track = undefined;
        var n = r(805), i = r(543), a = r(906), o = r(882), s = r(362), c = r(518), u = new WeakMap, h = function () {
          function t(t, e) {
            ...
            if (this.instrument = new s.Instrument(t, this), this.channel = 0, t) {
              ...
              this.endOfTrackTicks = undefined !== f ? f.absoluteTime : undefined;
            }
          }
          return t.prototype.addNote = function (t) {
            var e = u.get(this), r = new c.Note({midi: 0, ticks: 0, velocity: 1}, {ticks: 0, velocity: 0}, e);
            ...
            return t;
          }, enumerable: false, configurable: true}), t.prototype.fromJSON = function (t) {
            var e = this;
            for (var r in this.name = t.name, this.channel = t.channel, this.instrument = new s.Instrument(undefined, this), this.instrument.fromJSON(t.instrument), undefined !== t.endOfTrackTicks && (this.endOfTrackTicks = t.endOfTrackTicks), t.controlChanges) t.controlChanges[r] && t.controlChanges[r].forEach(function (t) {
            ...
            var r = {channel: this.channel, controlChanges: t, pitchBends: this.pitchBends.map(function (t) {
              return t.toJSON();
            }), instrument: this.instrument.toJSON(), name: this.name, notes: this.notes.map(function (t) {
              return t.toJSON();
            })};
            return undefined !== this.endOfTrackTicks && (r.endOfTrackTicks = this.endOfTrackTicks), r;
          }, t;
        }();
        e.Track = h;
      }}, e = {};
